...
//
//import com.prads.bet.controllers.dto.BetDTO;
...
//import com.prads.bet.repository.BetRepository;
...
//
//    private final static Logger LOGGER = LoggerFactory.getLogger(BetController.class);
//
//    @GetMapping("/{id}")
...
//            LOGGER.error("Bet not found with id {}", id);
//            return ResponseEntity.status(HttpStatus.NOT_FOUND).body(String.format("Bet not found with id %s", id));
//        }
//
//        return ResponseEntity.ok(BetDTO.fromBet(optional.get()));
//    }
//
//    @PostMapping
//    @Transactional
//    @CacheEvict(value = "bet", allEntries = true)
...
//        return betRepository.findById(id).map(bet -> {
//            betRepository.delete(bet);
//            return ResponseEntity.ok().body("Bet deleted.");
//        }).orElseGet(() -> {
//            LOGGER.error("Bet not found with id {}", id);
//            return ResponseEntity.status(HttpStatus.NOT_FOUND).body(String.format("Bet not found with id %s", id));
//        });
